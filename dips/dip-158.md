...
* "Reference ID", "Common Payment Identifier", "Payment Identifier" - A unique identifier of the payment. It should be a UUID according to RFC4122 with "-"'s included. See also [Reference ID in DIP-1](https://github.com/diem/dip/blob/main/dips/dip-1.mdx#terminology)
