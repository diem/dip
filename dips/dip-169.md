...
* Secondary signer: This is any account that participates in a multi-agent transaction that isn’t the primary signer. There can be 0-N of these. The 0 case is a normal transaction today. 
