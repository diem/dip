...
A pre-requisite for the off-chain negotiations is that both parties (sending and receiving VASPs) have shared a common payment identifier and the receiver address. This common payment idenbtifier is required to support a successive off-chain protocol between the VASPs. 
...
See [Appendix A](#appendix-a---pre-requisite-sharing-common-payment-identifier-and-address)
...
|ReadyNotification|Sender > Receiver|This functionality allows the wallet to indicate the payment is ready for settlement. The wallet is expected to submit a transaction on-chain immediately before or after declaring it is ready|Reference ID||
...
{
  "_ObjectType": "CommandRequestObject",
  "command_type": "ReadyNotification",
  "cid": "3185027f-0574-6f55-2668-3a38fdb5de98",
  "command": {
    "_ObjectType": "ReadyNotification",      
    "reference_id": "4185027f-0574-6f55-2668-3a38fdb5de98"
  }
}

```
#### ReadyNotification Response
```
{
  "_ObjectType": "CommandResponseObject",
  "status": "success",
...
|3|ReadyNotification|Sender|The wallet indicates the payment is ready for settlement. The wallet is expected to submit a transaction on-chain immediately before or after this step| 
...
|2|ReadyNotification|Sender|The wallet indicates the payment is ready for settlement. The wallet is expected to submit a transaction on-chain immediately before or after this step|
