...
**Version**: The state of an Object at a specific point in time. Upon creation an Object is assigned version 0. Every creation or mutation increases the Version of the Object which was created/mutated by one.  VASPs operate upon the latest Version of Shared Objects.  Once a Version is mutated, it is no longer a valid Version upon which a new Command may depend - the newly updated value of the Version is the latest Version for that Object and must be acted upon.
